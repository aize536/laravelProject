                    ...
                    <div class="panel-body">
                        ...
                        <form action="" class="form-horizontal" wire:submit.prevent="saveSettings">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" placeholder="Pinterest" class="form-control input-md" wire:model="instagram">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" placeholder="Pinterest" class="form-control input-md" wire:model="youtube">
                                </div>
                            </div>
