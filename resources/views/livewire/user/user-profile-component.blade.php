            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="col-md-4">
                        ...
                        @else
                            <img src="{{asset('assets/images/profile/default.png')}}" width="100%" style="border-radius:50%;">
                        @endif
                    </div>
                    <div class="col-md-8">
                        ...
                        <a href="{{route('user.editprofile')}}" class="btn btn-info pull-right">UpdateProfile</a>
                    </div>
                </div>
            </div>
        </div>
